  ...
  return (
    <>
      <link
        ...
        sizes='180x180'
        href='/logo/colored/favicon/apple-touch-icon.png'
      />
      <link
        rel='icon'
        type='image/png'
        sizes='32x32'
        href='/logo/colored/favicon/favicon-32x32.png'
      />
      <link
        rel='icon'
        type='image/png'
        sizes='16x16'
        href='/logo/colored/favicon/favicon-16x16.png'
      />
      <link rel='manifest' href='/logo/colored/favicon/site.webmanifest' />
      <link
        rel='mask-icon'
        href='/logo/colored/favicon/safari-pinned-tab.svg'
        color='#8743ff'
      />
      ...
      <meta
        ...
        content='/logo/colored/favicon/browserconfig.xml'
      />
...
<link rel="manifest" href="/logo/colored/favicon/site.webmanifest" />
<link rel="mask-icon" href="/logo/colored/favicon/safari-pinned-tab.svg" color="#8743ff" />
<link rel="shortcut icon" href="/logo/colored/favicon/favicon.ico" />
<meta name="msapplication-TileColor" content="#0a0a0a" />
